...
import { History, QrCode, Calendar, ArrowRight, Download } from "lucide-react";
          ...
          {scanHistories.length > 0 ? (
            <div className="space-y-3">
              {scanHistories.map((scan) => (
                <Card key={scan.id} className="border-slate-800 bg-slate-900/80 p-4 flex items-center justify-between hover:border-slate-700 transition-colors">
